...
{  	
    ...
    int32_t i, j, k, ig, i0=0, i1=0, L0=0, L1=1, m, nL, nf10 = n_files/10; //int64_t? 
...
{  	
    ...
    //2. Read files
    int32_t va, i, j, k, ig, i0=0, i1=0, L0=0, L1=1, m, nL, nf10=n_files/10; //int64_t?        		
    while(i0<n_files){
        //2.1 Start from (i0, L0): read till (i1, L1)
        ig = i0; 
        m = 0;    
