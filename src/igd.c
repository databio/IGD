...
char *fileBase = "_b14_";         
uint32_t nmax[] = {16040, 15680, 12860, 12340, 11770, 11090, 10360, 9470, 8960, 8710, 8810, 
        8680, 7400, 6940, 6610, 5930, 5470, 5260, 3920, 4250, 3080, 3340, 9980, 3710};
char *folder[] = {"chr1", "chr2", "chr3", "chr4", "chr5", "chr6", "chr7", "chr8", 
        "chr9", "chr10", "chr11", "chr12", "chr13", "chr14", "chr15", "chr16", 
     	 "chr17", "chr18", "chr19", "chr20", "chr21", "chr22", "chrX", "chrY"};
uint32_t gstart[25] = {0, 16040, 31720, 44580, 56920, 68690, 79780, 90140, 99610, 108570, 
        117280, 126090, 134770, 142170, 149110, 155720, 161650, 167120, 172380, 176300, 
        180550, 183630, 186970, 196950, 200660}; 
uint32_t nTiles = 200660;
