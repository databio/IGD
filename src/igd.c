...
char *fileBase = "_b14_";
char gfile[] = " ";	//assume it is in input file folder and will cp to output folder   

uint32_t *nmax, *gstart;
char** folder;

//----This is the default genome sizes--hg19 
     
uint32_t nmax0[] = {16040, 15680, 12860, 12340, 11770, 11090, 10360, 9470, 
...
char *folder0[] = {"chr1", "chr2", "chr3", "chr4", "chr5", "chr6", "chr7", "chr8", 
...
uint32_t gstart0[] = {0, 16040, 31720, 44580, 56920, 68690, 79780, 90140, 99610, 108570,
...
uint32_t nTiles = 203400, nChr = 92;
